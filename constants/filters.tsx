    ...
    search: {
      filters: [
...

        {
          ...
          type: "dynamicSearch",
          initialValue: "",
          endpoint: `${ADMIN_GATEWAY}/api/request/marketer/Search?Type=2`,
          valueField: ["title", "tbsReagentName"],
          queryField: "UniqueId",
          recordField: "id",
        },
        {
          title: "marketerId",
          name: " بازاریاب (کد ملی)",
          type: "dynamicSearch",
          initialValue: "",
          endpoint: `${ADMIN_GATEWAY}/api/request/marketer/Search?Type=1`,
          valueField: ["title", "tbsMarketerName"],
          queryField: "UniqueId",
          recordField: "id",
        },
        {
  ...
  "customer-management_legal_person": {
    ...
    search: {
      filters: [
        ...
        { title: "isDissolved", name: "منحل شده؟", type: "selectInput" },
        { title: "createDateTime", name: "تاریخ ایجاد", type: "singleDate" },
        { title: "updateDateTime", name: "تاریخ ویرایش", type: "singleDate" },
      ],
      initialValue: {
        PageNumber: 1,
        PageSize: 20,
  ...
  "customer-management_private_portfolio": {
    ...
    search: {
      filters: [
        ...
        { title: "StartDate", name: "تاریخ ابتدا", type: "singleDate" },
        { title: "EndDate", name: "تاریخ انتها", type: "singleDate" },
      ],
      initialValue: {
        PageNumber: 1,
        PageSize: 20,
