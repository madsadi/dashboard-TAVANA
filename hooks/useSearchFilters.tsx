import { prepare, seperate_modules } from '../components/common/functions/permission-utils';
...
export function useSearchFilters(module: string, feature?: string) {
    ...
    let services = dictionary[module]?.services !== undefined ? Object.keys(dictionary[module]?.services) : []
