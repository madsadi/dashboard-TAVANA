...
export default function ExtraDateAndTimeInput({
  query,
  setQuery,
}: {
  query: any;
  ...
  const [customerApprovalDate, setCustomerApprovalDate] =
  ...
  const customerApprovalDateInput = ({ ref }: { ref: any }) => (
    <div>
        ...
        {query?.["customerApprovalDateTime"]?.date ? (
          <XCircleIcon
            ...
            onClick={() => {
              ...
              queryUpdateDateAndTime("customerApprovalDateTime", "date", null);
            }}
          />
        ) : null}
      </label>
      <input
        ...
        readOnly
        ref={ref}
        value={singleDateHandler(customerApprovalDate)}
      />
    </div>
  );
  const adminApprovalDateInput = ({ ref }: { ref: any }) => (
    <div>
        ...
        {query?.["adminApprovalDateTime"]?.date ? (
          <XCircleIcon
            ...
            onClick={() => {
              ...
              queryUpdateDateAndTime("adminApprovalDateTime", "date", null);
            }}
          />
        ) : null}
      </label>
      <input
        ...
        ref={ref}
        id="rangeDate"
        value={singleDateHandler(adminApprovalDate)}
      />
    </div>
  );
  const startDateInput = ({ ref }: { ref: any }) => (
    <div>
      <label className={"flex items-center"}>
        ...
        {query?.["startDateTime"]?.date ? (
          <XCircleIcon
            ...
            onClick={() => {
              setStartDate(null);
              queryUpdateDateAndTime("startDateTime", "date", null);
            }}
          />
        ) : null}
      </label>
      <input
        ...
        ref={ref}
        id="rangeDate"
        value={singleDateHandler(startDate)}
      />
    </div>
  );
  const endDateInput = ({ ref }: { ref: any }) => (
    <div>
      <label className={"flex items-center"}>
        ...
        {query?.["endDateTime"]?.date ? (
          <XCircleIcon
            ...
            onClick={() => {
              setEndDate(null);
              queryUpdateDateAndTime("endDateTime", "date", null);
            }}
          />
        ) : null}
      </label>
      <input
        ...
        ref={ref}
        id="rangeDate"
        value={singleDateHandler(endDate)}
      />
    </div>
  );

  const queryUpdateDateAndTime = (
    parent: string,
    child: string,
    value: any
  ) => {
  ...
  return (
    <div className={"grid grid-cols-2 gap-4 mt-2"}>
      <div className={"z-[2]"}>
        <label className={"mt-auto flex items-center"}>زمان تائید مشتری</label>
        <DatePicker
          ...
          onChange={(e) => {
            ...
            queryUpdateDateAndTime(
              ...
              "date",
              `${moment
                .from(`${e?.year}/${e?.month}/${e?.day}`, "en", "YYYY/MM/DD")
                .format("YYYY-MM-DD")}`
            );
          }}
        ...
        <div className={"flex items-center space-x-reverse space-x-2 mt-1"}>
          <div className={"grow"}>
            ...
            <div className="relative rounded">
              <Listbox
                name={"minute"}
                value={query?.customerApprovalDateTime?.minute}
                onChange={(e) =>
                  queryUpdateDateAndTime(
                    "customerApprovalDateTime",
                    "minute",
                ...
                {({ open }) => (
                  <div className="relative">
                    <Listbox.Button className="relative flex min-w-full cursor-pointer rounded-md border border-border bg-white py-1.5 px-2 shadow-sm focus:border-border focus:outline-none">
                      <span className="flex items-center">
                        <span className="ml-2 block truncate text-sm">
                          {
                            query?.customerApprovalDateTime?.minute?.split(
                              ":"
                            )?.[0]
                          }
                        </span>
                    ...
                    <Transition
                      ...
                      leaveTo="opacity-0"
                    >
                      <Listbox.Options className="absolute z-10 mt-1 min-w-full max-h-40 divide-y divide-border bg-white border border-border overflow-auto custom-scrollbar rounded-md focus:outline-none">
                        {FindEnum("customerApprovalDateTime", []).minutes.map(
                          (item: any) => (
                            <Listbox.Option
                              key={item}
                              className={({ active }) =>
          ...
          <div className={"grow"}>
            ...
            <div className="relative rounded">
              <Listbox
                name={"hour"}
                value={query?.customerApprovalDateTime?.hour}
                onChange={(e) =>
                  queryUpdateDateAndTime(
                    "customerApprovalDateTime",
                    "hour",
              ...
              >
                {({ open }) => (
                  <div className="relative">
                    ...
                    >
                      <Listbox.Options className="absolute z-10 mt-1 min-w-full max-h-40 divide-y divide-border bg-white border border-border overflow-auto custom-scrollbar rounded-md focus:outline-none">
                        {FindEnum("customerApprovalDateTime", []).hours.map(
                          (item: any) => (
                            <Listbox.Option
                              key={item}
                              className={({ active }) =>
        ...
        <div className={"flex items-center space-x-reverse space-x-2 mt-1"}>
          <div className={"grow"}>
            ...
            <div className="relative rounded">
              <Listbox
                name={"minute"}
                value={query?.adminApprovalDateTime?.minute}
                onChange={(e) =>
                  queryUpdateDateAndTime(
                    "adminApprovalDateTime",
                    "minute",
                  ...
                  <div className="relative">
                    <Listbox.Button className="relative flex min-w-full cursor-pointer rounded-md border border-border bg-white py-1.5 px-2 shadow-sm focus:border-border focus:outline-none">
                      <span className="flex items-center">
                        <span className="ml-2 block truncate text-sm">
                          {
                            query?.adminApprovalDateTime?.minute?.split(
                              ":"
                            )?.[0]
                          }
                        </span>
                    ...
                    >
                      <Listbox.Options className="absolute z-10 mt-1 min-w-full max-h-40 divide-y divide-border bg-white border border-border overflow-auto custom-scrollbar rounded-md focus:outline-none">
                        {FindEnum("adminApprovalDateTime", []).minutes.map(
                          (item: any) => (
                            <Listbox.Option
                              key={item}
                              className={({ active }) =>
          ...
          <div className={"grow"}>
            ...
            <div className="relative rounded">
              <Listbox
                name={"hour"}
                value={query?.adminApprovalDateTime?.hour}
                onChange={(e) =>
                  queryUpdateDateAndTime(
                    "adminApprovalDateTime",
                    "hour",
              ...
              >
                {({ open }) => (
                  <div className="relative">
                    ...
                    >
                      <Listbox.Options className="absolute z-10 mt-1 min-w-full max-h-40 divide-y divide-border bg-white border border-border overflow-auto custom-scrollbar rounded-md focus:outline-none">
                        {FindEnum("adminApprovalDateTime", []).hours.map(
                          (item: any) => (
                            <Listbox.Option
                              key={item}
                              className={({ active }) =>
        ...
        <div className={"flex items-center space-x-reverse space-x-2 mt-1"}>
          <div className={"grow"}>
            ...
            >
              ...
              {query?.["startDateTime"]?.minute ? (
                <XCircleIcon
                  className="h-5 w-5 text-gray-400 mr-2 cursor-pointer"
                  onClick={() =>
                    queryUpdateDateAndTime("startDateTime", "minute", null)
                  }
                />
              ) : null}
            </label>
            <div className="relative rounded">
              <Listbox
                name={"minute"}
                value={query?.startDateTime?.minute}
                onChange={(e) =>
                  queryUpdateDateAndTime("startDateTime", "minute", `${e}:00`)
                }
              >
                {({ open }) => (
                  <div className="relative">
                    <Listbox.Button className="relative flex min-w-full cursor-pointer rounded-md border border-border bg-white py-1.5 px-2 shadow-sm focus:border-border focus:outline-none">
                      <span className="flex items-center">
                        <span className="ml-2 block truncate text-sm">
                          {query?.startDateTime?.minute?.split(":")?.[0]}
                        </span>
                      </span>
                      <span className="pointer-events-none flex items-center mr-auto">
                        <ChevronDownIcon
                    ...
                    >
                      <Listbox.Options className="absolute z-10 mt-1 min-w-full max-h-40 divide-y divide-border bg-white border border-border overflow-auto custom-scrollbar rounded-md focus:outline-none">
                        {FindEnum("startDateTime", []).minutes.map(
                          (item: any) => (
                            <Listbox.Option
                              key={item}
                              className={({ active }) =>
          ...
          <div className={"grow"}>
            ...
            >
              ...
              {query?.["startDateTime"]?.hour ? (
                <XCircleIcon
                  className="h-5 w-5 text-gray-400 mr-2 cursor-pointer"
                  onClick={() =>
                    queryUpdateDateAndTime("startDateTime", "hour", null)
                  }
                />
              ) : null}
            </label>
            <div className="relative rounded">
              <Listbox
                name={"hour"}
                value={query?.startDateTime?.hour}
                onChange={(e) =>
                  queryUpdateDateAndTime("startDateTime", "hour", `T${e}:`)
                }
              >
                {({ open }) => (
                  <div className="relative">
                    ...
                    >
                      <Listbox.Options className="absolute z-10 mt-1 min-w-full max-h-40 divide-y divide-border bg-white border border-border overflow-auto custom-scrollbar rounded-md focus:outline-none">
                        {FindEnum("startDateTime", []).hours.map(
                          (item: any) => (
                            <Listbox.Option
                              key={item}
                              className={({ active }) =>
        ...
        <div className={"flex items-center space-x-reverse space-x-2 mt-1"}>
          <div className={"grow"}>
            ...
            >
              ...
              {query?.["endDateTime"]?.minute ? (
                <XCircleIcon
                  className="h-5 w-5 text-gray-400 mr-2 cursor-pointer"
                  onClick={() =>
                    queryUpdateDateAndTime("endDateTime", "minute", null)
                  }
                />
              ) : null}
            </label>
            <div className="relative rounded">
              <Listbox
                name={"minute"}
                value={query?.endDateTime?.minute}
                onChange={(e) =>
                  queryUpdateDateAndTime("endDateTime", "minute", `${e}:00`)
                }
              >
                {({ open }) => (
                  <div className="relative">
                    <Listbox.Button className="relative flex min-w-full cursor-pointer rounded-md border border-border bg-white py-1.5 px-2 shadow-sm focus:border-border focus:outline-none">
                      <span className="flex items-center">
                        <span className="ml-2 block truncate text-sm">
                          {query?.endDateTime?.minute?.split(":")?.[0]}
                        </span>
                      </span>
                      <span className="pointer-events-none flex items-center mr-auto">
                        <ChevronDownIcon
                    ...
                    >
                      <Listbox.Options className="absolute z-10 mt-1 min-w-full max-h-40 divide-y divide-border bg-white border border-border overflow-auto custom-scrollbar rounded-md focus:outline-none">
                        {FindEnum("endDateTime", []).minutes.map(
                          (item: any) => (
                            <Listbox.Option
                              key={item}
                              className={({ active }) =>
          ...
          <div className={"grow"}>
            ...
            >
              ...
              {query?.["endDateTime"]?.hour ? (
                <XCircleIcon
                  className="h-5 w-5 text-gray-400 mr-2 cursor-pointer"
                  onClick={() =>
                    queryUpdateDateAndTime("endDateTime", "hour", null)
                  }
                />
              ) : null}
            </label>
            <div className="relative rounded">
              <Listbox
                name={"hour"}
                value={query?.endDateTime?.hour}
                onChange={(e) =>
                  queryUpdateDateAndTime("endDateTime", "hour", `T${e}:`)
                }
              >
                {({ open }) => (
                  <div className="relative">
