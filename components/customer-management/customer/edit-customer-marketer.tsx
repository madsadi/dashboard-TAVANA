...
export default function EditCustomerMarketer() {
  const { mutate } = useMutation({
    url: `${ADMIN_GATEWAY}/api/request/customer/EditMarketer`,
    method: "PATCH",
  });
  ...
  return (
    <>
      ...
      />
      <Modal title={` ویرایش بازاریاب مشتری `} setOpen={setModal} open={modal}>
