...
export default function EditCustomerReagent() {
  const { mutate } = useMutation({
    url: `${ADMIN_GATEWAY}/api/request/customer/EditReagent`,
    method: "PATCH",
  });
  ...
  return (
    <>
      ...
      />
      <Modal title={` ویرایش معرف مشتری `} setOpen={setModal} open={modal}>
