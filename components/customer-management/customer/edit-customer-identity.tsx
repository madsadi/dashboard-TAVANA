...
export default function EditCustomerIdentity() {
  const { mutate } = useMutation({
    url: `${ADMIN_GATEWAY}/api/request/customer/EditPersonOrigin`,
    method: "PATCH",
  });
  ...
  return (
    <>
      ...
      />
      <Modal title={` ویرایش ماهیت مشتری `} setOpen={setModal} open={modal}>
