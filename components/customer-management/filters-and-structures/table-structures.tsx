...
export const branchesColumnDefStructure = [
  ...
  },
  {
    ...
    cellRendererSelector: () => {
      const ColourCellRenderer = (rowData: any) => {
        return <span>{rowData.data.code}</span>;
      };
      const moodDetails = {
    ...
    cellRendererSelector: () => {
      const ColourCellRenderer = (rowData: any) => {
        return (
          <span>
            {
              TypeOfBranches.find((item: any) => item.id === rowData.data.type)
                ?.title
            }
          </span>
        );
  ...
  },
  {
    ...
    cellRendererSelector: () => {
      const ColourCellRenderer = (rowData: any) => {
        return <span>{rowData.data.isDeleted ? "حذف شده" : "حذف نشده"}</span>;
      };
      const moodDetails = {
        component: ColourCellRenderer,
      };
...
export const businessUnitColumnDefStructure = [
  ...
  },
  {
    ...
    cellRendererSelector: () => {
      const ColourCellRenderer = (rowData: any) => {
        return <span>{rowData.data.businessUnitOrder}</span>;
      };
      const moodDetails = {
        component: ColourCellRenderer,
      };
...
export const stationColumnDefStructure = [
  ...
  },
  {
    ...
    cellRendererSelector: () => {
      const ColourCellRenderer = (rowData: any) => {
        return <span>{rowData.data.brokerCode}</span>;
      };
      const moodDetails = {
        component: ColourCellRenderer,
      };
    ...
    cellRendererSelector: () => {
      const ColourCellRenderer = (rowData: any) => {
        return (
          <span>
            {
              stationTypeEnum.find((item: any) => item.id === rowData.data.type)
                ?.title
            }
          </span>
        );
...
export const contractColumnDefStructure = [
  ...
  },
  {
    ...
    cellRendererSelector: () => {
      return {
        component: (rowData: any) => (
          <DateCell date={rowData.data.passwordSetDate} />
        ),
      };
    },
  },
...
export const marketerContractColumnDefStructure = [
  ...
  },
  {
    ...
    cellRendererSelector: () => {
      const ColourCellRenderer = (rowData: any) => {
        return <span>{rowData.data["isValid"] ? "معتبر" : "نامعتبر"}</span>;
      };
      const moodDetails = {
        component: ColourCellRenderer,
      };
  ...
  },
  {
    ...
    cellRendererSelector: () => {
      return {
        component: (rowData: any) => (
          <DateCell date={rowData.data.contractStartDateTime} />
        ),
      };
    },
  },
  {
    ...
    cellRendererSelector: () => {
      return {
        component: (rowData: any) => (
          <DateCell date={rowData.data.contractEndDateTime} />
        ),
      };
    },
  },
...
export const customerAgreementColumnDefStructure = [
  ...
  {
    field: "isDeleted",
    headerName: "توافقنامه حذف شده است؟",
    valueFormatter: (rowData: any) => {
      return rowData.value ? "بله" : "خیر";
    },
  },
  ...
  {
    field: "stateTitle",
    headerName: "وضعیت توافقنامه",
  },
  {
    field: "customerStateDateTime",
    headerName: "زمان تغییر وضعیت مشتری",
    cellRendererSelector: () => {
      return {
        component: (rowData: any) => <DateCell date={rowData.value} />,
      };
    },
  },
  {
    field: "adminStateDateTime",
    headerName: "زمان تغییر وضعیت ادمین",
    cellRendererSelector: () => {
      return {
        component: (rowData: any) => <DateCell date={rowData.value} />,
      };
