...
export default function RoleSearchSection({ query, queryUpdate }: { query: QueryType, queryUpdate: (key: string, value: any) => void }) {
    const { fetchAsyncData } = useQuery({ url: `${IDP}/api/roles/search` })
    ...
    return (
        <div className={`relative`} ref={wrapperRef}>
            <div className={'relative'}>
                ...
                <input id="InstrumentId" className={'w-full h-[36px]'} value={role}
