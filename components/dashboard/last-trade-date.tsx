        ...
        if (index > 1) {
            sellCount({ date: date })
                .then(res => {
                    ...
                    _counts.splice(index, 1, { type: 'فروش', typeEng: 'sell', count: res?.data, date: date })
            ...
            buyCount({ date: date })
                .then(res => {
                    ...
                    _counts.splice(index, 1, { type: 'خرید', typeEng: 'buy', count: res?.data, date: date })
                    setCounts((prev: any) => [...prev, ..._counts])
                })
        }
    }
        ...
        series: [
            {
                ...
                tooltip: {
                    ...
                    renderer: function (params: AgPieSeriesTooltipRendererParams) {
                        return {
                            content: params.datum.count + params.datum.type + ' در تاریخ ' + params.datum.date
                        };
                    },
                },
            },
