...
export default function EditRegStateComponent() {
  ...
  const { mutate } = useMutation({
    url: `${ADMIN_GATEWAY}/api/request/EditRegistrationState`,
  });
  ...
  return (
    <>
      ...
      />
      <Modal title={"ویرایش اطلاعات کاربر"} setOpen={setModal} open={modal}>
