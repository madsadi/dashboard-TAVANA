...
export default function DeleteMarketerContractCoefDetail(props: any) {
  ...
  const { mutate } = useMutation({
    url: `${MARKETER_ADMIN}/marketer-contract-coefficient/delete`,
    method: "DELETE",
  });
  ...
  return (
    <>
      <Button
        className={"bg-error"}
        label="حذف ضریب قرارداد بازاریاب"
        onClick={openHandler}
      />
      <Modal
        title={"حذف ضریب قرارداد بازاریاب"}
        setOpen={setModal}
        open={modal}
      >
        <div className="field mt-4">
          <p className={"text-center"}>
            آیا از حذف کردن ضریب این قرارداد اطمینان دارید؟
          </p>
