...
import {shouldEditObject, shouldEditObject as shouldEditObjectFn} from "../../store/marketRulesConfig";
...
export default function Edit(){
    ...
    return(
        <>
            ...
            <button className="button bg-orange-500" onClick={openUpdate}>تغییر</button>
