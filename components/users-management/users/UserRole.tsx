                ...
                <div className="mt-4">
                    <div className={'grid grid-cols-2 gap-3'}>
                        ...
                        <div className={'flex flex-col'}>
                            ...
                            <div
                                className={'border border-gray-400 rounded-md p-3 grow overflow-y-auto space-y-2 custom-scrollbar'}>
                                <InfiniteScroll
                                    ...
                                    height={300}
                                    className={'custom-scrollbar h-full overflow-y-auto space-y-2'}
                                >
