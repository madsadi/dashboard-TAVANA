...
interface FilterItemOtherTypes extends FilterItemBasicType {
    type: "selectInput" | "input" | "date" | "searchRoles" | "password" | "selectInputTime" | "dynamicSelectInput" | "dateTimeInput" | "dynamic" | null,
}


export type FilterItemType = FilterItemOtherTypes | FilterItemDynamicType | FilterItemSearchType | FilterItemSingleDateType